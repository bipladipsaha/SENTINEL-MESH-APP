  ...
  void _updateMarkers() {
    ...
    for (var place in _stations) {
      options.add(mapbox.CircleAnnotationOptions(
        ...
        circleColor: AppColors.colorAquaMint.value,
        circleRadius: 8.0,
      ...
      body: Stack(
        children: [
          ...
          if (_currentLocation != null)
            ...
            const Center(child: CircularProgressIndicator(color: AppColors.colorAquaMint)),
                  ...
                  child: Row(
                    children: [
                      ...
                      Container(
                        ...
                        child: const Icon(Icons.filter_list, color: AppColors.colorAquaMint),
                      ),
                    ],
                  ),
                ),
                  ...
                  Padding(
                    ...
                    child: Align(
                      ...
                      child: Container(
                        ...
                        child: Text('${_stations.length} Stations Found Nearby', style: AppTextStyles.captionTech),
                      ),
                    ),
                  ),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              const Icon(Icons.local_police, color: AppColors.colorAquaMint, size: 14),
              const SizedBox(width: 4),
              Text(distanceText, style: AppTextStyles.captionTech.copyWith(color: AppColors.colorAquaMint)),
            ],
          ),
          const Spacer(),
          Row(
