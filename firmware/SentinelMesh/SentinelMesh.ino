...
void setup() {
    ...
    uint16_t macId = (uint16_t)(chipid >> 32); // Use upper 2 bytes to create a 16-bit short ID
    
    g_state.deviceIdShort = macId;
    snprintf(g_state.deviceIdStr, sizeof(g_state.deviceIdStr), "SM-%05u", macId);

    Serial.printf("[MAIN] Device ID generated: %s\n", g_state.deviceIdStr);
    ...
    xTaskCreatePinnedToCore(taskBLE,             "BLE",  4096,                 NULL, 1,    NULL,   1);
